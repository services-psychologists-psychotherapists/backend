...
from .views.psychologist import (
    ApproacheViewSet,
    CreatePsychologistView,
    FreeSlotsView,
    InstituteViewSet,
    PsychoCardCatalogView,
    PsychoListCatalogView,
    PsychologistProfileView,
    ShortPsychoCardCatalogView,
    ThemeViewSet,
    UploadFileView,
)
...
urlpatterns = [
    ...
    # Каталог психологов
    path(
        "psychologists/<uuid:id>/short/",
        ShortPsychoCardCatalogView.as_view(),
        name="short_psycho_card",
    ),
    path(
        "psychologists/<uuid:id>/free_slots/",
